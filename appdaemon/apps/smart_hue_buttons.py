...
class smart_hue_buttons(hass.Hass): 
    def initialize(self):
        ...
        self.listen_event(self.callback_long_press_on_living_room_coridor_switch_button_on, "hue_event", device_id = "efa42240bac38d83b77963e7fd5bb5ac", unique_id = "9df3f0e5-001b-4c7b-9c5d-a96a8b391edd", type = "repeat", subtype = 1)
        self.listen_event(self.callback_long_press_on_living_room_coridor_switch_button_off, "hue_event", device_id = "efa42240bac38d83b77963e7fd5bb5ac", unique_id = "73e97207-29d2-4078-8304-9e918425fe48", type = "repeat", subtype = 4)
