...
### Flow (trace-style)
- Triggers:
  - Machine à laver Tâche en cours (Salle de bains) to “finish”
- Conditions (all must be true):
  - No extra conditions
- Actions:
  - Set État machine à laver (Salle de bains) to “À vider”
...
### Déroulé (style ‘trace’)
- Déclencheurs :
  - Machine à laver Tâche en cours (Salle de bains) à “finish”
- Conditions (toutes doivent être vraies) :
  - Pas de condition supplémentaire
- Actions :
  - Mettre État machine à laver (Salle de bains) sur “À vider”
