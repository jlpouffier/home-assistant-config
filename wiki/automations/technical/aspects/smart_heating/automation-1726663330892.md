# Chauffage intelligent - 🛎️ Notifier Température anormale Bureau / Chauffage intelligent - 🛎️ Notifier Température anormale Bureau
...
- `power_notification_script`: Power Notification - Température anormale dans le bureau
- `room_name`: Le bureau
- `room_openings`: Fenêtre (Bureau)
- `room_openings_duration`: 00:05:00
- `room_temperature`: Température (Bureau)
