# Chauffage intelligent - 🛎️ Notifier Température anormale Chambre / Chauffage intelligent - 🛎️ Notifier Température anormale Chambre
...
- `power_notification_script`: Power Notification - Température anormale dans la chambre
- `room_name`: La chambre
- `room_openings`: Fenêtre (Chambre)
- `room_openings_duration`: 00:05:00
- `room_temperature`: Température (Chambre)
