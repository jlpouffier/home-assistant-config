...
### Flow (trace-style)
- Triggers:
  - Mode chauffage/clim (Chambre)
  - Cible chauffage absent (Chambre)
  - Cible chauffage présent (Chambre)
...
- Actions:
  - CHOOSE (first match)
    - Branch 1
      - Check: Mode chauffage/clim (Chambre) is “Présent”
      - THEN
        - Set value Cible chauffage (Chambre)
    - Branch 2
      - Check: Mode chauffage/clim (Chambre) is “Absent”
      - THEN
        - Set value Cible chauffage (Chambre)
    - Branch 3
      - Check: Mode chauffage/clim (Chambre) is “Frost Guard”
      - THEN
        - Set value Cible chauffage (Chambre)
...
- Actions :
  - CHOISIR (première branche valide)
    - Branche 1
      - Vérifier : Mode chauffage/clim (Chambre) est “Présent”
      - ALORS
        - Action : set value sur Cible chauffage (Chambre)
    - Branche 2
      - Vérifier : Mode chauffage/clim (Chambre) est “Absent”
      - ALORS
        - Action : set value sur Cible chauffage (Chambre)
    - Branche 3
      - Vérifier : Mode chauffage/clim (Chambre) est “Frost Guard”
      - ALORS
        - Action : set value sur Cible chauffage (Chambre)
