...
### Flow (trace-style)
- Triggers:
  - Planning Poubelle Noire (Rue) from “off” to “on”
- Conditions (all must be true):
  - No extra conditions
- Actions:
  - Turn on Poubelle noire à sortir (Rue)
...
### Déroulé (style ‘trace’)
- Déclencheurs :
  - Planning Poubelle Noire (Rue) de “off” à “on”
- Conditions (toutes doivent être vraies) :
  - Pas de condition supplémentaire
- Actions :
  - Activer Poubelle noire à sortir (Rue)
