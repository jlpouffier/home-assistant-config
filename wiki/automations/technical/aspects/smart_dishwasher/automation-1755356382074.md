# Lave vaisselle - Annulation du lavage / Lave vaisselle - Annulation du lavage
...
### Summary
- Runs when: État (Cuisine) to “aborting”
- Only if: No extra conditions
- Then: Set État lave vaisselle to “Inactif”

```mermaid
flowchart TD
  T1["État (Cuisine) to “aborting”"]
...
### Résumé
- Se déclenche quand : État (Cuisine) à “aborting”
- Uniquement si : Pas de condition supplémentaire
- Ensuite : Mettre État lave vaisselle sur “Inactif”

```mermaid
flowchart TD
  T1["État (Cuisine) à “aborting”"]
