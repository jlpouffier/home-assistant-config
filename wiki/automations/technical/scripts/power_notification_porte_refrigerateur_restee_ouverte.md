# Power Notification - Porte réfrigérateur restée ouverte / Power Notification - Porte réfrigérateur restée ouverte
...
- `default_message`: La porte du réfrigérateur est restée ouverte!
- `default_title`: 🧊 Frigo
- `discard_when`: Porte Réfrigérateur (Cuisine) to “off”
...
- `default_message` : La porte du réfrigérateur est restée ouverte!
- `default_title` : 🧊 Frigo
- `discard_when` : Porte Réfrigérateur (Cuisine) à “off”
- `replace_older_notification` : True
- `target` : send_to_persons_in_zones
- `zones` : Maison
